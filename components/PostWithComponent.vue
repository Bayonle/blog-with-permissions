<template>
  <div class="w-full mb-10">
    ...
    <div class="flex items-center mt-5">
      ...
      <can-do allowed="approve_post">
        <button
          @click="approve"
          class="rounded px-4 py-2 text-sm bg-blue-500 text-white mx-3"
        >Approve</button>
      </can-do>
      <can-do allowed="publish_post">
        <button
          @click="publish"
          class="rounded px-4 py-2 text-sm bg-blue-500 text-white"
        >Publish</button>
      </can-do>
    </div>
  </div>
